...
- **Trope Master**: Distinguishes between effective clichés and stale tropes to avoid
...
- Propose tropes to utilize and clichés to avoid
...
- Zero stale clichés (or subversive use)
...
### Isekai Fantasy
- ✅ Summoning method: Summoned while missing the bus (ordinary→extraordinary contrast)
- ✅ Special ability: [Needs definition]
- ✅ Other-world rules: Demon lord subjugation quest
- ⚠️ Return motivation: [TBD]
